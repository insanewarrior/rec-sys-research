...
standpoint this amounts to discarding substantial supervised information, and
...
metrics degrade. The architecture provides a path to disable intensity, yet the optimiser does not take it. A
...
that the chosen normalisation suppressed the information it contained.
